  ...
  return (
    <>
      <div className={styles['nextbody']}>
        {/* 首頁大圖 */}
        <section className={styles['headpic']}>
          <div className={styles['blog-headimg']}>
            <img src="/image/home-hero-bg.jpg" />
          </div>
        </section>
        {/* 大圖內文字 */}
        <div className={styles['headtext']}>
          ...
          <div className={styles['hero__title']}>
            ...
            <p className={styles['hero__title-dynamic-text1']}>的最佳夥伴</p>
          </div>
          ...
          <div className="container">
            <div className={styles['join__container']}>
              ...
              <div className={styles['join__outer-shape']}>
                <div className={styles['join__inner-shape']}>
                  {' '}
                  <Image
                    src={homeImage}
        ...
        <section className={styles['forum']}>
          <div
            className={`${styles['container']} ${styles['forum__container']}`}
          >
            <h3
